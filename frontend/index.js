document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const paginationControls = document.getElementById('pagination-controls'); // Pagination container
        // Pagination variables
        const itemsPerPage = 10; // Number of items per page
        let currentPage = 1;
        const populateSectionFilter = () => {
            const sections = [...new Set(data.map(student => student.section || 'N/A'))].sort();
            sectionFilter.innerHTML = '<option value="all">All</option><option value="all">Hostelers</option><option value="all">Dayscholar</option>';
...
"2215500045",
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            const pageData = sortedData.slice(start, end); // Slice data for the current page
        ...
        const graph=()=>{
            ...
            filteredData.forEach((student, index) =>{
                console.log(residence[index]);
                if(residence[index]!=="Hostellers") dayCount=dayCount+student.totalSolved;
                else HostelCount=HostelCount+student.totalSolved;
            })
      ...
      new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['Hostelers', 'DayScholar'],
          datasets: [{
            label: '# of Votes',
            data: [HostelCount,dayCount],
            borderWidth: 1
          }]
        },
        options: {
        ...
        document.getElementById('sort-section').addEventListener('click', () => {
            ...
            // const check=document.getElementById('sort-section');
            // if(check==="Hostelers" || check==="Dayscholar"){
            //     const sortedData = filteredData.filter(e=>{
            //     });
            // }
            // else{
