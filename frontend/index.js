...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        function fetchJSONData() {
            fetch("E:\tbppp\Batch-4-Test\data1.json")
                .then((res) => {
                    if (!res.ok) {
                        throw new Error
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${student.previousTotal || 'N/A'}

                    </td>
                    <td class="p-4 text-green-400">
                    ${student.easySolved || 'N/A'}
                    <button id="sort-medium" class="ml-2 text-blue-400 hover:text-white">
                                    <i class="fas fa-sort"></i>
                                </button>
                    </td>
                    <td class="p-4 text-yellow-400">${student.mediumSolved || 'N/A'}
                    <button id="sort-medium" class="ml-2 text-blue-400 hover:text-white">
                                    <i class="fas fa-sort"></i>
                                </button></td>
                    <td class="p-4 text-red-400">${student.hardSolved || 'N/A'}
                    <button id="sort-medium" class="ml-2 text-blue-400 hover:text-white">
                                    <i class="fas fa-sort"></i>
                                </button></td>
                `;
        ...
        document.getElementById('section-filter').addEventListener('click',()=>{
        ...
        document.getElementById('sort-previous').addEventListener('click', () => {
            totalSolvedDirection = totalSolvedDirection === 'desc' ? 'asc' : 'desc';
            const sortedData = sortData(filteredData, 'previousTotal', totalSolvedDirection, true);
            renderLeaderboard(sortedData);
        });
