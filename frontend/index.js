document.addEventListener('DOMContentLoaded', async () => {
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${student.totalSolved > oldData [student.roll] ? '⬆' + (student.totalSolved - oldData[student.roll]) :  totalSolved || 'N/A'}</td>
    ...
    const data = {
        ...
        datasets: [{
            label: 'Hosteller vs Day Scholar',
            data: [hostellerCount, dayScholarCount]
