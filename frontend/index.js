var oldData = {
    ...
    try {
        ...
        const exportToCSV = (data) => {
            const headers = ['Rank', 'Roll Number', 'Name','Appraised', 'Section', 'Total Solved', 'Easy', 'Medium', 'Hard', 'LeetCode URL'];
            const csvRows = data.map((student, index) => {
                return [
                    index + 1,
                    student.roll,
                    student.name,
                    student.appraised || 'N/A',
                    student.section || 'N/A',
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${student.appraised || 'N/A'}</td>
