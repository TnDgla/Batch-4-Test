document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const populateSectionFilter = () => {
            ...
            sectionFilter.innerHTML = '<option value="day">Day schloars</option>';
            sectionFilter.innerHTML = '<option value="hostllers">Hostllers</option>';
        ...
        const exportToCSV = (data) => {
            const headers = ['Rank', 'Extra', 'Roll Number', 'Name', 'Section', 'Total Solved', 'Easy', 'Medium', 'Hard', 'LeetCode URL'];
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                let e = student?.totalSolved -  oldData[r];
