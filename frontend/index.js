    ...
    try {
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                const ques=student.totalSolved-oldData[student.roll];
                ...
                row.innerHTML = `
                    ...
                    <td class="flex p-4">${student.totalSolved || 'N/A'}</td>
                   
                    <div class="flex-p gap-3 items-center">
                    
                     <i class="fa-solid fa-arrow-up"></i>
                      <p class="text-white"?>${ques}</p>
                     </div>
        ...
        searchBtn.addEventListener('click', ()=>{
            ...
            filteredData = data.filter(student => (student.name).includes(target));
            renderLeaderboard(filteredData)
        })
