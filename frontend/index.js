        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4 text-red-400">${oldData[student.roll] + "->" + student.totalSolved || 'N/A'}</td>
                    <td class="p-4 text-red-400">${"+"+student.totalSolved-oldData[student.roll] || 'N/A'}</td>
                    <td class="p-4 text-red-400">${student.residence || 'N/A'}</td>
                `;
