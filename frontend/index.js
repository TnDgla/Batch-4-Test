document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const populateSectionFilter = () => {
            ...
            const residences = [...new Set(data.map(student =>  student.resi || 'N/A'))].sort();
            sectionFilter.innerHTML = '<option value="all">All</option>';
            ...
            residences.forEach(resi => {
                const option = document.createElement('option');
                option.value = resi;
                option.textContent = resi;
                sectionFilter.appendChild(option);
            });
        };
        var oldData = {
        ...
        const exportToCSV = (data) => {
            const headers = ['Rank', 'Roll Number', 'Name', 'Section', 'Total Solved', 'Easy', 'Medium', 'Hard', 'Residence', 'LeetCode URL'];
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${student.totalSolved || 'N/A'} -> +${student.totalSolved - oldData[student.roll]}</td>
                    <td class="p-4 text-green-400">${student.easySolved || 'N/A'}</td>
                    <td class="p-4 text-yellow-400">${student.mediumSolved || 'N/A'}</td>
                    <td class="p-4 text-red-400">${student.hardSolved || 'N/A'}</td>
                    <td class="p-4">${student.resi || 'N/A'}</td>
                `;
        ...
        const filterData = (section) => {
            filteredData = section === 'all' 
                ? [...data]
                : data.filter(student => (student.section || 'N/A') === section || (student.resi || 'N/A') === section);
