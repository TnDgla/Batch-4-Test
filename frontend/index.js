document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const exportToCSV = (data) => {
            const headers = ['Rank', 'Increasing','Roll Number', 'Name', 'Section', 'Total Solved', 'Easy', 'Medium', 'Hard', 'LeetCode URL'];
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                const p = student?.roll;
                const row = document.createElement('tr');
                row.classList.add('border-b', 'border-gray-700');
                row.innerHTML = `
                    <td class="p-4">${index + 1}</td>
                    <td class="p-4">${student.totalSolved-oldData[p]}
        ...
        // <!-- implement a movement feature : you are provided with past data problems solved by the students here https://pastebin.com/8zsrRqNf -->
