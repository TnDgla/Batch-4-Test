...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${'+'+(student.totalSolved-student.previousTotal) || 'N/A'}</td>
        ...
        document.getElementById('sort-previous').addEventListener('click', () => {
            previousDirection = previousDirection === 'desc' ? 'asc' : 'desc';
            const sortedData = sortData(filteredData, 'previousTotal', previousDirection, true);
            renderLeaderboard(sortedData);
