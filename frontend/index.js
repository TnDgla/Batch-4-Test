...
console.log(filteredData[0])
        ...
        const exportToCSV = (data) => {
            const headers = ['Rank', 'Roll Number', 'Name', 'Section', 'Total Solved', 'Easy', 'Medium', 'Hard', 'LeetCode URL', 'Residence'];
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${oldData[student.roll]<student.totalSolved?"⬆️"+oldData[student.roll]+"-"+student.totalSolved:"🟰"+student.totalSolved}</td>
