...
"Hostellers",
        ...
        let dpm={};
        for(let i=0;i<residance.length;++i){
            dpm[arr3[i]]=residance[i];
        }
        console.log(dpm['2215001606']);
        const populateSectionFilter = () => {
            const sections = [...new Set(data.map(student => student.section || 'N/A'))].sort();

           
            let arr4=Object.keys(dpm);
            arr4=new Set(arr4);
            console.log(arr4);
            let arr5=Object.values(dpm);
            arr5=new Set(arr5);
            console.log(arr5);
            ...
            sections.forEach(section => {
                ...
                option.value = dpm[section];
                option.textContent = section;
                sectionFilter.appendChild(option);
            });


            arr5.forEach(section => {
                const option = document.createElement('option');
                option.value = dpm[section];
                option.textContent = section;
                sectionFilter.appendChild(option);
        ...
        const exportToCSV = (data) => {
            ...
            const csvRows = data.map((student, index) => {
                ...
                return [
                    ...
                    student.totalSolved-oldData[student.roll],
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4 text-yellow-400"> + ${student.totalSolved-oldData[student.roll] || 'N/A'}</td>
                `;
