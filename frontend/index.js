        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4 text-white-400">${student.roll}+'->'+${student.totalSolved} =${student.totalSolved - student.roll}</td>
                    <td class="p-4 text-white-400">${'+' +eval+{student.totalSolved-oldData{student.poll}}} </td>
